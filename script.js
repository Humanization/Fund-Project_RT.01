...
const CONFIG = {
    ...
    whatsapp1: {
        name: "Admin 1 - Cash ([NAMA_ADMIN_CASH])",
        number: "6281234567890", // Placeholder Nomor WA Admin 1 (Tanpa tanda +)
        method: "Cash / Tunai"
    },
    // Opsi 2: Admin 2 (Khusus Pembayaran Transfer / QRIS)
    whatsapp2: {
        name: "Admin 2 - QRIS/Transfer ([NAMA_ADMIN_QRIS])",
        number: "6289876543210", // Placeholder Nomor WA Admin 2 (Tanpa tanda +)
